...
func (s *TransactionService) CreateTransaction(t dto.TransactionRequest) (*entities.Transaction, error) {
	transaction := entities.NewTransaction(t.PaymentMethod, t.Total)
	return s.repo.CreateTransaction(transaction)
}

func (s *TransactionService) UpdateTransaction(id uint, t dto.TransactionRequest) error {
