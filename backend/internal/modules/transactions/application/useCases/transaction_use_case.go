...
import (
	...
	"github.com/javierjpv/edenBooks/internal/modules/transactions/domain/ports/services"
)
...
func (u *TransactionUseCase) CreateTransaction(t dto.TransactionRequest) (*entities.Transaction, error) {
	...
	transactionEntity:=entities.NewTransaction(t.PaymentMethod,t.Total)
	return u.service.CreateTransaction(transactionEntity)
}
...
func (u *TransactionUseCase) UpdateTransaction(id uint, t dto.TransactionRequest) error {
	...
	return u.service.UpdateTransaction(transactionEntity)
}
