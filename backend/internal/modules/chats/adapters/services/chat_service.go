...
import (
	...
	"github.com/javierjpv/edenBooks/internal/modules/chats/domain/ports/repositories"
)
...
func (s *ChatService) CreateChat(chat *entities.Chat) (*entities.Chat, error) {
...
func (s *ChatService) UpdateChat( chat *entities.Chat) error {
