...
import (
	...
	"github.com/javierjpv/edenBooks/internal/modules/chats/domain/ports/services"
...
func (u *ChatUseCase) CreateChat(c dto.ChatRequest) (*entities.Chat, error) {
	chatEntity := entities.NewChat()
	return u.service.CreateChat(chatEntity)
}
...
func (u *ChatUseCase) UpdateChat(id uint, c dto.ChatRequest) error {
	...
	return u.service.UpdateChat(chatEntity)
}
...
func (u *ChatUseCase) GetChatByID(id uint) (*dto.ChatResponse, error) {
	...
	// Convertir cada mensaje en MessageResponse
