...
import (
	"fmt"
"github.com/javierjpv/edenBooks/internal/modules/orders/domain/ports/services"
...
func (u *OrderUseCase) CheckOrder(o dto.OrderRequest, productsIDs []uint) error {
	...
	orderEntity := entities.NewOrder(o.State, o.UserID, o.AddressID, o.CarrierID, o.TransactionID)
	return u.service.CheckOrder(orderEntity, productsIDs)
}
...
func (u *OrderUseCase) CreateOrder(o dto.OrderRequest, productsIDs []uint) error {
	...
	orderEntity := entities.NewOrder(o.State, o.UserID, o.AddressID, o.CarrierID, o.TransactionID)
	return u.service.CreateOrder(orderEntity, productsIDs)
}
...
func (u *OrderUseCase) UpdateOrder(id uint, o dto.OrderRequest) error {
	...
	orderEntity := entities.NewOrder(o.State, o.UserID, o.AddressID, o.CarrierID, o.TransactionID)
	orderEntity.ID = id // Asignamos el ID

	return u.service.UpdateOrder(orderEntity) // Pasa *entities.Order
}
