...
func (s *NotificationService) CreateNotification(n dto.NotificationRequest) error {
	notification := entities.NewNotification(n.Content, n.Seen, n.UserID)
	return s.repo.CreateNotification(notification)
}

func (s *NotificationService) UpdateNotification(id uint, n dto.NotificationRequest) error {
