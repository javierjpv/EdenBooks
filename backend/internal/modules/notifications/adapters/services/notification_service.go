...
import (
	...
	"github.com/javierjpv/edenBooks/internal/modules/notifications/domain/ports/repositories"
...
func (s *NotificationService) CreateNotification(n *entities.Notification) error {
	return s.repo.CreateNotification(n)
}

func (s *NotificationService) UpdateNotification(n *entities.Notification) error {
