...
func (s *AddressService) CreateAddress(a dto.AddressRequest) (*entities.Address, error) {
...
func (s *AddressService) UpdateAddress(id uint, a dto.AddressRequest) error {
...
func (s *AddressService) CheckExistingAdress(a dto.AddressRequest) (bool, error) {
	return false, nil
