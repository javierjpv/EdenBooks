...
import (
	...
	"github.com/javierjpv/edenBooks/internal/modules/reviews/domain/ports/services"
)
...
func (u *ReviewUseCase) CreateReview(r dto.ReviewRequest) error {
	...
	reviewEntity:=entities.NewReview(r.Rating,r.Comment,r.UserID,r.ProductID)
	return u.service.CreateReview(reviewEntity)
}
...
func (u *ReviewUseCase) UpdateReview(id uint, r dto.ReviewRequest) error {
	...
	reviewEntity:=entities.NewReview(r.Rating,r.Comment,r.UserID,r.ProductID)
	reviewEntity.ID=id
	return u.service.UpdateReview(reviewEntity)
}
