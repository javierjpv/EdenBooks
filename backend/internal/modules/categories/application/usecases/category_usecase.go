...
import (
	...
	"github.com/javierjpv/edenBooks/internal/modules/categories/domain/ports/services"
)
...
func (u *CategoryUseCase) CreateCategory(c dto.CategoryRequest) error {
	if c.Name == "" || c.Description == "" {
		return ErrMissingFields
	}
	categoryEntity:=entities.NewCategory(c.Name,c.Description)
	return u.service.CreateCategory(categoryEntity)
}
...
func (u *CategoryUseCase) UpdateCategory(id uint, c dto.CategoryRequest) error {
	...
	return u.service.UpdateCategory(categoryEntity)
}
