...
// const BASE_URL = "http://localhost:6969/notifications";
const BASE_URL = "/notifications";

export const notificationApi: INotificationApi = {
  CreateNotification: async ( notification: INotification): Promise<ApiResponse<INotification>> => {
    try {
  ...
  UpdateNotification: async (id, notification: INotification): Promise<ApiResponse<INotification>> => {
    try {
